...
func executeCommands(commands []config.Command) {
	...
	for i, c := range commands {
		...
		command, procSig := system.MustStartProcess(commandBinaryPath, commandWorkingDirectory, c.Arguments, c.Env, !*flags.NoStreamPassing)
